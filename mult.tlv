...
\TLV mfa_w(#_width, $_in1, $_in2, $_co, $_cin, $_out, $_pr, $_gn, /_top)
   /slice[#_width-1:0]
      $cinn = ( #slice == 0) ? /_top$_co : /_top$_cin;
...
\TLV h_mul(#_width, $_in1, $_in2, $_out, 

\TLV cla_4($_in1, $_in2, $_co, $out, $cout, /_top)
   m4+mfa_w(4,$_in1, $_in2, $_co, $_cin_cla, $out, $_pr, $_gn, /_top)
   m4+look_ahead_logic_w(4,$_co, $_pr, $_gn, $gpr, $ggn, $_cin_cla, /_top)
